...
var (
	...
	Get struct {
		...
		UploadURLBase string   `yaml:"upload-url-base"`
	}
)
...
const (
	...
	uploadURLBaseKey = "UPLOAD_URL_BASE"
)
...
func setDefaults() {
	...
	Get.UploadURLBase = defaultUploadURLBase
}
...
func overrideWithEnvVars() {
	...
	Get.UploadURLBase = envAsStr(uploadURLBaseKey, Get.UploadURLBase)
}
